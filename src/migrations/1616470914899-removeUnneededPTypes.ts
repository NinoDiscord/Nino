...
export class removeUnneededPTypes1616470914899 implements MigrationInterface {
    name = 'removeUnneededPTypes1616470914899'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "punishments" DROP COLUMN "roleID"`);
        ...
        await queryRunner.query(`CREATE TYPE "punishments_type_enum" AS ENUM('voice.undeafen', 'voice.unmute', 'voice.deafen', 'voice.mute', 'unmute', 'unban', 'kick', 'mute', 'ban')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`COMMENT ON COLUMN "punishments"."type" IS NULL`);
        await queryRunner.query(`CREATE TYPE "punishments_type_enum_old" AS ENUM('voice.deafen', 'role.remove', 'voice.mute', 'role.add', 'unmute', 'unban', 'kick', 'mute', 'ban')`);
        ...
        await queryRunner.query(`COMMENT ON COLUMN "guilds"."modlogChannelID" IS NULL`);
        await queryRunner.query(`ALTER TABLE "punishments" ADD "roleID" character varying`);
    }
