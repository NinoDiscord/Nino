...
export class init1616159355187 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
      ...
      await queryRunner.query('CREATE TYPE "punishments_type_enum" AS ENUM(\'role.remove\', \'role.add\', \'unmute\', \'unban\', \'kick\', \'ban\')');
      await queryRunner.query('CREATE TABLE "punishments" ("warnings" integer NOT NULL DEFAULT \'1\', "guild_id" character varying NOT NULL, "roleID" character varying, "index" SERIAL NOT NULL, "soft" boolean NOT NULL DEFAULT false, "time" integer, "type" "punishments_type_enum" NOT NULL, CONSTRAINT "PK_b08854374ef88515861c1bf6cd8" PRIMARY KEY ("guild_id", "index"))');
      ...
      await queryRunner.query('CREATE TABLE "warnings" ("guild_id" character varying NOT NULL, "case_id" character varying NOT NULL, "reason" character varying, "amount" integer NOT NULL DEFAULT \'0\', "user_id" character varying NOT NULL, CONSTRAINT "PK_7a14eba00a6aaf0dc04f76aff02" PRIMARY KEY ("user_id"))');
    }
