...
export default class ReadyEvent extends Event {
    ...
    async emit() {
        this.bot.logger.log('discord', `Logged in as ${this.bot.client.user.username}#${this.bot.client.user.discriminator} (${this.bot.client.user.id})`);
        ...
        this.bot.promServer.listen(5595, () => this.bot.logger.log('info', 'Metrics is now listening on port \'5595\''));
